...
| `CLICKHOUSE_AGENT_PASSWORD` / `ANALYTICS_AGENT_ALLOWED_USERS` | generate / empty | The analytics agent's read-only warehouse login, and who may run it — see below |
