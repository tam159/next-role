# PRD: UI/UX Modernization (v1)

**Status:** shipped · **Scope:** `frontend/` (whole UI) · **Extends:** [Color-coded Workspace File Cards](09_file_category_colors.md), [Configurable LLM Models](15_configurable_llm_models.md)
