---
type: PRD
title: "First-Run Upload Guidance"
description: "Actionable empty states, an in-grid upload tile, and a dismissible pulse cue drive the critical first upload — no coach-mark arrows."
tags: [frontend, ui, files]
timestamp: '2026-07-12T23:17:55+07:00'
status: "shipped"
scope: "frontend/ (chat empty state, Workspace Files)"
version: v1
---

**Extends:** [File Upload](01_file_upload.md)
