---
type: PRD
title: "Bulk-Delete Dialog Shows Full Paths"
description: "The bulk-delete confirmation lists full virtual paths keyed by path, fixing duplicate-basename React key collisions and ambiguous rows."
tags: [frontend, files, ui]
timestamp: '2026-06-12T09:37:01+07:00'
status: "shipped"
scope: "Workspace > Files panel"
version: v1
---

**Extends:** [Multi-Select Delete for Workspace Files](14_multi_select_file_delete.md)
...
- **Single-file dialog keeps the basename.** [PRD 14](14_multi_select_file_delete.md) promised "single-delete reads exactly as before", and a lone `<span>` can't key-collide. The basename now comes from the existing `splitFilePath` helper instead of an inline `split("/").pop()`.
