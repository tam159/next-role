# PRD: Interview Battlecard — JSON + PDF via weasyprint (v1)

**Status:** shipped · **Scope:** career_agent / main agent, Stage 5 · **Extends:** [agent_workflow](08_agent_workflow.md), mirrors [tailored_resume_pdf](07_tailored_resume_pdf.md)
