...
from grpc_common.checkpointer import GrpcCheckpointer
...
if TYPE_CHECKING:
    ...
    from api._checkpointer.protocol import (
        CheckpointerProtocol,
        FullCheckpointerProtocol,
    )
    from grpc_common.proto.checkpointer_pb2_grpc import CheckpointerStub
...
async def get_checkpointer(
    *,
    ...
    from runtime.checkpoint import Checkpointer  # noqa: PLC0415
