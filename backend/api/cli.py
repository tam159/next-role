...
if typing.TYPE_CHECKING:
    ...
    from api.config import AuthConfig, HttpConfig, StoreConfig
...
def _resolve_server_url(
    ...
    *mount_prefix* (if any) is appended to the result.
    """
    from api.utils.network import format_hostport  # noqa: PLC0415
    ...
    from api.tunneling.cloudflare import start_tunnel  # noqa: PLC0415
