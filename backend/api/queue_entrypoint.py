...
from api.api.meta import meta_pool_stats
from api.utils.errors import GraphLoadError, HealthServerStartupError
from api.utils.network import format_hostport, normalize_host
...
async def health_and_metrics_server():
    ...
    from api import config as lc_config  # noqa: PLC0415
    from api.api.meta import METRICS_FORMATS  # noqa: PLC0415
...
async def entrypoint(
    ...
    from api import logging as lg_logging  # noqa: PLC0415
    from api import timing  # noqa: PLC0415
    from api.api import user_router  # noqa: PLC0415
