...
from api.encryption.middleware import decrypt_response
from api.encryption.shared import BLOB_ENCRYPTION_CONTEXT_KEY
from api.feature_flags import IS_POSTGRES_OR_GRPC_BACKEND
from api.models.run import create_valid_run
from api.schema import Cron
...
if IS_POSTGRES_OR_GRPC_BACKEND:
    from api.grpc.ops import Crons
else:
    from runtime.ops import Crons
