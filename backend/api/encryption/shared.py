...
if TYPE_CHECKING:
    from api.encryption.aes_json import AesEncryptionInstance
    from api.encryption.custom import JsonEncryptionWrapper
...
def get_encryption() -> JsonEncryptionWrapper | AesEncryptionInstance | None:
    ...
    from api.encryption.aes_json import (  # noqa: PLC0415
        get_aes_encryption_instance,
    )
    from api.encryption.custom import (  # noqa: PLC0415
...
def using_custom_encryption() -> bool:
    ...
    """
    from api.encryption.custom import JsonEncryptionWrapper  # noqa: PLC0415
...
def using_aes_encryption() -> bool:
    ...
    """
    from api.encryption.aes_json import AesEncryptionInstance  # noqa: PLC0415
    from api.encryption.custom import JsonEncryptionWrapper  # noqa: PLC0415
