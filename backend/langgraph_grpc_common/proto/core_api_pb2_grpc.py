...
def add_AdminServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("coreApi.Admin", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
def add_ThreadsServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("coreApi.Threads", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
def add_RunsServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("coreApi.Runs", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
def add_CronsServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("coreApi.Crons", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
def add_CacheServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("coreApi.Cache", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
