...
from server.api import config, timing
...
from server.grpc_common.checkpointer import GrpcCheckpointer
...
if TYPE_CHECKING:
    ...
    from server.api._checkpointer.protocol import (
        CheckpointerProtocol,
        FullCheckpointerProtocol,
    )
    from server.grpc_common.proto.checkpointer_pb2_grpc import CheckpointerStub
...
async def get_checkpointer(
    *,
    ...
    from server.runtime.checkpoint import Checkpointer  # noqa: PLC0415
