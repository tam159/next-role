...
from server.api.encryption.shared import using_custom_encryption
...
from server.grpc_common.proto import encryption_pb2 as enc_pb

_MAX_AUTH_FILTER_DEPTH = 2

if TYPE_CHECKING:
    from server.api.schema import Context
...
def map_if_exists(if_exists: str) -> Any:
    ...
    from server.grpc_common.proto import core_api_pb2 as pb  # noqa: PLC0415
