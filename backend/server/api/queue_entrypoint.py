...
from server.api.api.meta import meta_pool_stats
from server.api.utils.errors import GraphLoadError, HealthServerStartupError
from server.api.utils.network import format_hostport, normalize_host
from server.runtime import lifespan
from server.runtime.database import healthcheck
from server.runtime.metrics import get_metrics
...
async def health_and_metrics_server():
    ...
    from server.api import config as lc_config  # noqa: PLC0415
    from server.api.api.meta import METRICS_FORMATS  # noqa: PLC0415
...
async def entrypoint(
    ...
    from server.api import logging as lg_logging  # noqa: PLC0415
    from server.api import timing  # noqa: PLC0415
    from server.api.api import user_router  # noqa: PLC0415
    from server.api.server import app  # noqa: PLC0415
