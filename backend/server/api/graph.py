...
from server.api import config as lg_api_config
from server.api import timing
from server.api._factory_utils import (
    AccessContext,
...
from server.api.asyncio import as_asynccontextmanager
from server.api.feature_flags import (
    IS_POSTGRES_OR_GRPC_BACKEND,
    USE_RUNTIME_CONTEXT_API,
)
from server.api.js.base import BaseRemotePregel, is_js_path
from server.api.schema import Config
from server.api.timing import profiled_import
from server.api.utils.config import run_in_executor, var_child_runnable_config
from server.api.utils.errors import GraphLoadError
...
async def register_graph(
    ...
    *,
    ...
    """Register a graph."""
    from server.runtime.database import connect  # noqa: PLC0415

    if IS_POSTGRES_OR_GRPC_BACKEND:
        from server.api.grpc.ops import Assistants  # noqa: PLC0415
    else:
        from server.runtime.ops import Assistants  # noqa: PLC0415
    ...
    from server.runtime.retry import retry_db  # noqa: PLC0415
...
async def get_graph(
    ...
    *,
    ...
    """Return the runnable."""
    from server.api.utils import config as lg_config  # noqa: PLC0415
    from server.api.utils import merge_auth  # noqa: PLC0415
...
async def collect_graphs_from_env(register: bool = False) -> None:
    ...
    if js_specs:
        ...
        from server.api.js.remote import (  # noqa: PLC0415
            RemotePregel,
            run_js_http_process,
            run_js_process,
