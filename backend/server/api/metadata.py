...
# (api/meta.py). All are None for self-hosted deployments; the envs are only
# set by managed control planes.
...
# NextRole is open source and ships no license machinery; every feature tier
# is always on.
PLAN = "enterprise"
