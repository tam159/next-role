...
from server.api.auth.errors import AuthError
from server.api.auth.langsmith.backend import LangsmithAuthBackend
from server.api.auth.studio_user import StudioUser
...
async def handle_event(
    ...
    if auth == "js":
        from server.api.js.remote import handle_js_auth_event  # noqa: PLC0415
...
def _get_custom_auth_middleware(
    ...
    if auth_instance == "js":
        from server.api.js.remote import CustomJsAuthBackend  # noqa: PLC0415
