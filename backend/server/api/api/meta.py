...
from server.api import __version__, config, metadata
from server.api.feature_flags import IS_POSTGRES_OR_GRPC_BACKEND
from server.api.http_metrics import HTTP_METRICS_COLLECTOR
from server.api.route import ApiRequest
from server.api.schema import PoolStats, PostgresPoolStats, RedisPoolStats
from server.runtime.database import connect, pool_stats
...
def _pool_stats_to_prometheus_lines(
    ...
    """Format merged pool stats as Prometheus text lines (same format as runtime.database.pool_stats)."""
