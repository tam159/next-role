...
from server.api.graph import get_assistant_id, get_graph
from server.api.js.base import BaseRemotePregel
from server.api.route import ApiRequest, ApiResponse, ApiRoute
from server.api.schema import ASSISTANT_ENCRYPTION_FIELDS, ASSISTANT_FIELDS
...
if IS_POSTGRES_OR_GRPC_BACKEND:
    from server.api.grpc.ops import Assistants
else:
    from server.runtime.ops import Assistants
