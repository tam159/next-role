...
from server.api.schema import PoolStats
from server.api.serde import fragment_loads, json_dumpb
from server.runtime_postgres import redis
from server.runtime_postgres.redis import LOCK_MIGRATION
...
def _apply_store_config() -> None:
    ...
    """
    from server.runtime_postgres import store as lg_store
