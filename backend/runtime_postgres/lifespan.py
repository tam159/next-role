...
from api.config import BG_JOB_SHUTDOWN_GRACE_PERIOD_SECS
from runtime_postgres import (
    checkpoint,
    database,
    long_query_monitor,
    queue,
...
async def lifespan(
    ...
    *,
    ...
    if config.LANGGRAPH_LOGS_ENABLED:
        from api import self_hosted_logs
    ...
    try:
        ...
        from api.grpc.client import close_shared_client
