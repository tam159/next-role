...
from api.schema import PoolStats
from api.serde import fragment_loads, json_dumpb
from runtime_postgres import redis
from runtime_postgres.redis import LOCK_MIGRATION
...
def _apply_store_config() -> None:
    ...
    """
    from runtime_postgres import store as lg_store
