...
from runtime_postgres.database import stop_pool
from runtime_postgres.redis import LIST_RUN_QUEUE, get_redis
...
async def queue():
    from api import graph, webhook, worker
    from api.asyncio import AsyncQueue
    from api.schema import Run
