...
class ContainsAuthFilter(_message.Message):
    ...
    def __init__(
        self,
        key: _Optional[str] = ...,
        matches: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class OrAuthFilter(_message.Message):
    ...
    def __init__(
        self,
        filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
    ) -> None: ...
...
class AuthFilter(_message.Message):
    __slots__ = ("and_filter", "contains", "eq", "or_filter")
    ...
    def __init__(
        self,
        eq: _Optional[_Union[EqAuthFilter, _Mapping]] = ...,
        contains: _Optional[_Union[ContainsAuthFilter, _Mapping]] = ...,
        or_filter: _Optional[_Union[OrAuthFilter, _Mapping]] = ...,
        and_filter: _Optional[_Union[AndAuthFilter, _Mapping]] = ...,
    ) -> None: ...
...
class Assistant(_message.Message):
    ...
    def __init__(
        ...
        config: _Optional[_Union[_engine_common_pb2.EngineRunnableConfig, _Mapping]] = ...,
        context_json: _Optional[bytes] = ...,
        metadata_json: _Optional[bytes] = ...,
        name: _Optional[str] = ...,
...
class CreateAssistantRequest(_message.Message):
    ...
    def __init__(
        ...
        graph_id: _Optional[str] = ...,
        filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        if_exists: _Optional[_Union[OnConflictBehavior, str]] = ...,
        config: _Optional[_Union[_engine_common_pb2.EngineRunnableConfig, _Mapping]] = ...,
        context_json: _Optional[bytes] = ...,
        name: _Optional[str] = ...,
        description: _Optional[str] = ...,
...
class DeleteAssistantRequest(_message.Message):
    __slots__ = ("assistant_id", "delete_threads", "filters")
    ASSISTANT_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
...
class SetLatestAssistantRequest(_message.Message):
    __slots__ = ("assistant_id", "filters", "version")
    ASSISTANT_ID_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    assistant_id: str
...
class SearchAssistantsRequest(_message.Message):
    ...
    def __init__(
        ...
        sort_by: _Optional[_Union[AssistantsSortBy, str]] = ...,
        sort_order: _Optional[_Union[SortOrder, str]] = ...,
        select: _Optional[_Iterable[str]] = ...,
        name: _Optional[str] = ...,
    ) -> None: ...
...
class SearchAssistantsResponse(_message.Message):
    ...
    def __init__(
        self,
        assistants: _Optional[_Iterable[_Union[Assistant, _Mapping]]] = ...,
    ) -> None: ...

class GetAssistantVersionsRequest(_message.Message):
    __slots__ = ("assistant_id", "filters", "limit", "metadata_json", "offset")
    ASSISTANT_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    METADATA_JSON_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
...
class GetAssistantVersionsResponse(_message.Message):
    ...
    def __init__(
        self,
        versions: _Optional[_Iterable[_Union[AssistantVersion, _Mapping]]] = ...,
    ) -> None: ...
...
class TruncateRequest(_message.Message):
    __slots__ = ("assistants", "checkpointer", "runs", "store", "threads")
...
class ThreadTTLConfig(_message.Message):
    __slots__ = ("default_ttl", "strategy", "sweep_interval_minutes")
    ...
    def __init__(
        self,
        strategy: _Optional[_Union[ThreadTTLStrategy, str]] = ...,
        default_ttl: _Optional[float] = ...,
        sweep_interval_minutes: _Optional[int] = ...,
    ) -> None: ...
...
class CheckpointTask(_message.Message):
    __slots__ = ("error", "id", "interrupts_json", "name", "state_json")
    ...
    def __init__(
        ...
        name: _Optional[str] = ...,
        error: _Optional[str] = ...,
        interrupts_json: _Optional[_Iterable[bytes]] = ...,
        state_json: _Optional[bytes] = ...,
    ) -> None: ...

class CheckpointMetadata(_message.Message):
    __slots__ = ("parents", "source", "step")
    ...
    def __init__(
        self,
        source: _Optional[_Union[CheckpointSource, str]] = ...,
        step: _Optional[int] = ...,
        parents: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...

class CheckpointPayload(_message.Message):
    __slots__ = ("config", "metadata", "next", "parent_config", "tasks", "values_json")
    CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        config: _Optional[_Union[_engine_common_pb2.EngineRunnableConfig, _Mapping]] = ...,
        metadata: _Optional[_Union[CheckpointMetadata, _Mapping]] = ...,
        values_json: _Optional[bytes] = ...,
        next: _Optional[_Iterable[str]] = ...,
        parent_config: _Optional[_Union[_engine_common_pb2.EngineRunnableConfig, _Mapping]] = ...,
        tasks: _Optional[_Iterable[_Union[CheckpointTask, _Mapping]]] = ...,
    ) -> None: ...

class ThreadStatusCheckpoint(_message.Message):
    __slots__ = ("interrupts_json", "next", "values_json")
    VALUES_JSON_FIELD_NUMBER: _ClassVar[int]
    NEXT_FIELD_NUMBER: _ClassVar[int]
    INTERRUPTS_JSON_FIELD_NUMBER: _ClassVar[int]
    values_json: bytes
    ...
    def __init__(
        ...
        values_json: _Optional[bytes] = ...,
        next: _Optional[_Iterable[str]] = ...,
        interrupts_json: _Optional[bytes] = ...,
    ) -> None: ...

class Interrupt(_message.Message):
    __slots__ = ("id", "ns", "resumable", "value", "when")
    ID_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Interrupts(_message.Message):
    ...
    def __init__(
        self,
        interrupts: _Optional[_Iterable[_Union[Interrupt, _Mapping]]] = ...,
    ) -> None: ...
...
class Thread(_message.Message):
    ...
    class InterruptsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[Interrupts, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        metadata: _Optional[_Union[Fragment, _Mapping]] = ...,
        config: _Optional[_Union[Fragment, _Mapping]] = ...,
        status: _Optional[_Union[_enum_thread_status_pb2.ThreadStatus, str]] = ...,
        values: _Optional[_Union[Fragment, _Mapping]] = ...,
        interrupts: _Optional[_Mapping[str, Interrupts]] = ...,
        error: _Optional[_Union[Fragment, _Mapping]] = ...,
        extracted_json: _Optional[bytes] = ...,
    ) -> None: ...

class CreateThreadRequest(_message.Message):
    __slots__ = ("filters", "if_exists", "metadata_json", "thread_id", "ttl")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    IF_EXISTS_FIELD_NUMBER: _ClassVar[int]
    METADATA_JSON_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        if_exists: _Optional[_Union[OnConflictBehavior, str]] = ...,
        metadata_json: _Optional[bytes] = ...,
        ttl: _Optional[_Union[ThreadTTLConfig, _Mapping]] = ...,
    ) -> None: ...

class GetThreadRequest(_message.Message):
    __slots__ = ("filters", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    thread_id: UUID
    filters: _containers.RepeatedCompositeFieldContainer[AuthFilter]
...
class PatchThreadRequest(_message.Message):
    __slots__ = ("filters", "metadata_json", "thread_id", "ttl")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    METADATA_JSON_FIELD_NUMBER: _ClassVar[int]
    TTL_FIELD_NUMBER: _ClassVar[int]
...
class SearchThreadsRequest(_message.Message):
    ...
    def __init__(
        ...
        limit: _Optional[int] = ...,
        offset: _Optional[int] = ...,
        sort_by: _Optional[_Union[ThreadsSortBy, str]] = ...,
        sort_order: _Optional[_Union[SortOrder, str]] = ...,
        select: _Optional[_Iterable[str]] = ...,
        extract: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
...
class CountThreadsRequest(_message.Message):
    __slots__ = ("filters", "metadata_json", "status", "values_json")
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    METADATA_JSON_FIELD_NUMBER: _ClassVar[int]
    VALUES_JSON_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
...
class SetThreadStatusRequest(_message.Message):
    __slots__ = ("checkpoint", "exception_json", "expected_status", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        checkpoint: _Optional[_Union[ThreadStatusCheckpoint, _Mapping]] = ...,
        exception_json: _Optional[bytes] = ...,
        expected_status: _Optional[
            _Iterable[_Union[_enum_thread_status_pb2.ThreadStatus, str]]
        ] = ...,
    ) -> None: ...

class SetThreadJointStatusRequest(_message.Message):
    __slots__ = ("checkpoint", "exception_json", "graph_id", "run_id", "run_status", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        run_id: _Optional[_Union[UUID, _Mapping]] = ...,
        run_status: _Optional[str] = ...,
        graph_id: _Optional[str] = ...,
        checkpoint: _Optional[_Union[ThreadStatusCheckpoint, _Mapping]] = ...,
        exception_json: _Optional[bytes] = ...,
    ) -> None: ...
...
class StreamThreadRequest(_message.Message):
    __slots__ = ("filters", "last_event_id", "stream_modes", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    ...
    thread_id: UUID
    filters: _containers.RepeatedCompositeFieldContainer[AuthFilter]
    stream_modes: _containers.RepeatedScalarFieldContainer[
        _enum_thread_stream_mode_pb2.ThreadStreamMode
    ]
    last_event_id: str
    def __init__(
        self,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        stream_modes: _Optional[
            _Iterable[_Union[_enum_thread_stream_mode_pb2.ThreadStreamMode, str]]
        ] = ...,
...
class RunKwargs(_message.Message):
    ...
    def __init__(
        ...
        config: _Optional[_Union[_engine_common_pb2.EngineRunnableConfig, _Mapping]] = ...,
        context_json: _Optional[bytes] = ...,
        input_json: _Optional[bytes] = ...,
        command_json: _Optional[bytes] = ...,
        stream_mode: _Optional[_Union[_enum_stream_mode_pb2.StreamMode, str]] = ...,
        interrupt_before: _Optional[
            _Union[_engine_common_pb2.StaticInterruptConfig, _Mapping]
        ] = ...,
        interrupt_after: _Optional[
            _Union[_engine_common_pb2.StaticInterruptConfig, _Mapping]
        ] = ...,
        webhook: _Optional[str] = ...,
        feedback_keys: _Optional[_Iterable[str]] = ...,
        temporary: bool = ...,
        subgraphs: bool = ...,
        resumable: bool = ...,
        checkpoint_during: bool = ...,
        durability: _Optional[str] = ...,
    ) -> None: ...
...
class Run(_message.Message):
    ...
    def __init__(
        ...
        run_id: _Optional[_Union[UUID, _Mapping]] = ...,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        assistant_id: _Optional[_Union[UUID, _Mapping]] = ...,
        created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        status: _Optional[_Union[_enum_run_status_pb2.RunStatus, str]] = ...,
        metadata: _Optional[_Union[Fragment, _Mapping]] = ...,
        kwargs: _Optional[_Union[RunKwargs, _Mapping]] = ...,
        multitask_strategy: _Optional[
            _Union[_enum_multitask_strategy_pb2.MultitaskStrategy, str]
        ] = ...,
    ) -> None: ...
...
class RunStats(_message.Message):
    ...
    def __init__(
        self,
        n_pending: _Optional[int] = ...,
        n_running: _Optional[int] = ...,
        pending_runs_wait_time_max_secs: _Optional[float] = ...,
        pending_runs_wait_time_med_secs: _Optional[float] = ...,
        pending_unblocked_runs_wait_time_max_secs: _Optional[float] = ...,
    ) -> None: ...

class NextRunRequest(_message.Message):
    __slots__ = ("limit", "wait")
...
class NextRunResponse(_message.Message):
    ...
    def __init__(
        self,
        runs: _Optional[_Iterable[_Union[RunWithAttempt, _Mapping]]] = ...,
    ) -> None: ...
...
class CreateRunRequest(_message.Message):
    ...
    def __init__(
        self,
        assistant_id: _Optional[_Union[UUID, _Mapping]] = ...,
        kwargs_json: _Optional[bytes] = ...,
        thread_filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        assistant_filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        ...
        if_not_exists: _Optional[_Union[CreateRunBehavior, str]] = ...,
        after_seconds: _Optional[int] = ...,
        thread_ttl: _Optional[_Union[ThreadTTLConfig, _Mapping]] = ...,
    ) -> None: ...

class GetRunRequest(_message.Message):
    __slots__ = ("filters", "run_id", "thread_id")
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    run_id: UUID
...
class CancelRunIdsTarget(_message.Message):
    ...
    def __init__(
        self,
        thread_id: _Optional[_Union[UUID, _Mapping]] = ...,
        run_ids: _Optional[_Iterable[_Union[UUID, _Mapping]]] = ...,
    ) -> None: ...
...
class CancelRunRequest(_message.Message):
    __slots__ = ("action", "filters", "run_ids", "status")
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    RUN_IDS_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        self,
        filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        run_ids: _Optional[_Union[CancelRunIdsTarget, _Mapping]] = ...,
        status: _Optional[_Union[CancelStatusTarget, _Mapping]] = ...,
        action: _Optional[_Union[_enum_cancel_run_action_pb2.CancelRunAction, str]] = ...,
    ) -> None: ...

class SearchRunsRequest(_message.Message):
    __slots__ = ("filters", "limit", "offset", "select", "status", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
...
class StreamRunClientMessage(_message.Message):
    ...
    def __init__(
        self,
        subscribe: _Optional[_Union[SubscribeRunRequest, _Mapping]] = ...,
        join: _Optional[_Union[JoinRunRequest, _Mapping]] = ...,
    ) -> None: ...

class SubscribeRunRequest(_message.Message):
    __slots__ = ("run_id", "thread_id")
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    thread_id: UUID
    run_id: UUID
...
class JoinRunRequest(_message.Message):
    ...
    def __init__(
        self,
        filters: _Optional[_Iterable[_Union[AuthFilter, _Mapping]]] = ...,
        stream_modes: _Optional[_Iterable[_Union[_enum_stream_mode_pb2.StreamMode, str]]] = ...,
        ignore_run_not_found: bool = ...,
        cancel_on_disconnect: bool = ...,
        last_event_id: _Optional[str] = ...,
    ) -> None: ...
...
class EnterRunRequest(_message.Message):
    __slots__ = ("resumable", "run_id", "thread_id")
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    RESUMABLE_FIELD_NUMBER: _ClassVar[int]
    run_id: UUID
...
class PublishStreamEventRequest(_message.Message):
    __slots__ = ("event_type", "message", "resumable", "run_id", "thread_id")
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    EVENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
...
class ControlEvent(_message.Message):
    ...
    def __init__(
        self,
        action: _Optional[_Union[_enum_control_signal_pb2.ControlSignal, str]] = ...,
    ) -> None: ...
...
class Cron(_message.Message):
    ...
    def __init__(
        self,
        cron_id: _Optional[str] = ...,
        assistant_id: _Optional[str] = ...,
        thread_id: _Optional[str] = ...,
        on_run_completed: _Optional[str] = ...,
...
class SearchCronsRequest(_message.Message):
    ...
    def __init__(
        ...
        limit: _Optional[int] = ...,
        offset: _Optional[int] = ...,
        sort_by: _Optional[_Union[CronsSortBy, str]] = ...,
        sort_order: _Optional[_Union[SortOrder, str]] = ...,
        select: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class CountCronsRequest(_message.Message):
    __slots__ = ("assistant_id", "filters", "thread_id")
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    ASSISTANT_ID_FIELD_NUMBER: _ClassVar[int]
    THREAD_ID_FIELD_NUMBER: _ClassVar[int]
    filters: _containers.RepeatedCompositeFieldContainer[AuthFilter]
