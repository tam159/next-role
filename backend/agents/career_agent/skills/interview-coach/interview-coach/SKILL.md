...
3. Use `edit_file(output_path, old_string=..., new_string=...)` for targeted insertions (a new STAR story under a round, a new subsection, an updated question). Use `write_file` only when restructuring most of the doc.
